...
enum SoulWellData
 {
    ...
    ITEM_FEL_HEALTH_STONE_R0       = 36892,
    ITEM_FEL_HEALTH_STONE_R1       = 36893,
    ITEM_FEL_HEALTH_STONE_R2       = 36894,

    ITEM_MASTER_HEALTH_STONE_R0    = 22103,
    ITEM_MASTER_HEALTH_STONE_R1    = 22104,
    ITEM_MASTER_HEALTH_STONE_R2    = 22105,
};
                       // Soulwell for rank 2
class go_soulwell : public GameObjectScript
{
    public:
        ...
        struct go_soulwellAI : public GameObjectAI
         {
            ...
            bool GossipHello(Player* player)
            {
                ...
                uint32 stoneId = GetStone(_stoneSpell, go->GetEntry());
                if (_stoneSpell == 0 || stoneId == 0)
                    return true;
                ...
                if (player->HasItemCount(stoneId, 1))
                {
        ...
        private:
            ...
            uint32 GetStone(uint32 spellId, uint32 objectId)
            {
                switch (spellId)
                {
                    case SPELL_IMPROVED_HEALTH_STONE_R1:
                        return objectId == GO_soulwell_R2 ? ITEM_FEL_HEALTH_STONE_R1 : ITEM_MASTER_HEALTH_STONE_R1;
                    case SPELL_IMPROVED_HEALTH_STONE_R2:
                        return objectId == GO_soulwell_R2 ? ITEM_FEL_HEALTH_STONE_R2 : ITEM_MASTER_HEALTH_STONE_R2;
                    default:
                        return objectId == GO_soulwell_R2 ? ITEM_FEL_HEALTH_STONE_R0 : ITEM_MASTER_HEALTH_STONE_R0;
                }
                return 0;
            };
        };
