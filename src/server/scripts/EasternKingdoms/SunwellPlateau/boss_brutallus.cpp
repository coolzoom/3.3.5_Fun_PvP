...
enum MovementPoints
{
    POINT_MADRIGOSA_ONE = 1,
    POINT_MADRIGOSA_TWO = 2,
    POINT_MADRIGOSA_THREE = 3
};

#define FELMYST 25038

Position const MadrigosaFlyPosOne = { 1465.383f, 649.908f, 41.787f, 4.677f };
Position const MadrigosaFlyPosTwo = { 1460.000f, 652.510f, 50.707f, 4.836511f };
Position const MadrigosaFlyPosThree = { 1465.213135f, 637.802246f, 20.526630f, 4.753656f };
    ...
    struct boss_brutallusAI : public ScriptedAI
    {
        ...
        void DoIntro()
        {
            ...
            case 3:
                ...
                IntroPhaseTimer = 1 * IN_MILLISECONDS;
                ++IntroPhase;
                break;
            case 4:
                Madrigosa->GetMotionMaster()->MovePoint(POINT_MADRIGOSA_ONE, MadrigosaFlyPosOne);
                IntroPhaseTimer = 3 * IN_MILLISECONDS;
                ++IntroPhase;
                break;
            case 5:
                Madrigosa->GetMotionMaster()->MovePoint(POINT_MADRIGOSA_TWO, MadrigosaFlyPosTwo);
                IntroPhaseTimer = 5 * IN_MILLISECONDS;
                ++IntroPhase;
                break;
            case 6:
                Madrigosa->SetFacingToObject(me);
                DoCast(me, SPELL_INTRO_FROST_BLAST);
                IntroPhaseTimer = 2 * IN_MILLISECONDS;
                ++IntroPhase;
                break;
            case 7:
                Madrigosa->SetFacingToObject(me);
            ...
            case 10:
                ...
                break;
            case 11:
                Madrigosa->GetMotionMaster()->MovePoint(POINT_MADRIGOSA_THREE, MadrigosaFlyPosThree);
                Madrigosa->Attack(me, true);
                IntroPhaseTimer = 3 * IN_MILLISECONDS;
                ++IntroPhase;
                break;
