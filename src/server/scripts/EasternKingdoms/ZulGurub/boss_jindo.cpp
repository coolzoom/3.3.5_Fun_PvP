                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_BRAIN_WASH_TOTEM:
                            ...
                            events.ScheduleEvent(EVENT_BRAIN_WASH_TOTEM, urand(22000, 26000));
                            break;
                        case EVENT_POWERFULL_HEALING_WARD:
                            DoCast(me, SPELL_POWERFULL_HEALING_WARD);
                            events.ScheduleEvent(EVENT_POWERFULL_HEALING_WARD, urand(18000, 20000));
                            break;
                        case EVENT_HEX:
                        ...
                        case EVENT_TELEPORT:
                            ...
                            events.ScheduleEvent(EVENT_TELEPORT, urand(15000, 25000));
                            break;
                        default:
                            break;
                    }
