...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        static std::vector<ChatCommand> reloadCommandTable =
        {
            ...
            { "bad_word",                      SEC_ADMINISTRATOR,                                               true,  &HandleReloadBadWordCommand,                    "" }, //im really don't understand RBAC
            ...
            { "spelldamage",                   rbac::RBAC_PERM_COMMAND_RELOAD_SPELL_DAMAGE,                     true,  &HandleReloadSpellDamage,                       "" },
        };
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadSpellDamage(handler, "");		
        return true;
    }
    ...
    {
        TC_LOG_INFO("misc", "Re-Loading Letter Analogs...");
    ...
    static bool HandleReloadSpellDamage(ChatHandler* handler, const char* /*args*/)
    {
        TC_LOG_INFO("misc", "Reloading spell_damage table...");
        sSpellDamage->LoadFromDB();
        handler->SendGlobalGMSysMessage("Spell damage reloaded.");
        return true;
    }
};
