...
const char* Transmogrification::GetSlotName(uint8 slot, WorldSession* /*session*/) const
{
    ...
    switch (slot)
    {
        ...
        case EQUIPMENT_SLOT_NECK      : return  "Шея";// session->GetTrinityString(LANG_SLOT_NAME_NECK);
        ...
        case EQUIPMENT_SLOT_FINGER1   : return  "Кольцо 1";// session->GetTrinityString(LANG_SLOT_NAME_FINGER1);
        case EQUIPMENT_SLOT_FINGER2   : return  "Кольцо 2";// session->GetTrinityString(LANG_SLOT_NAME_FINGER2);
        case EQUIPMENT_SLOT_TRINKET1  : return  "Аксессуар 1";// session->GetTrinityString(LANG_SLOT_NAME_TRINKET1);
        case EQUIPMENT_SLOT_TRINKET2  : return  "Аксессуар 2";// session->GetTrinityString(LANG_SLOT_NAME_TRINKET2);
