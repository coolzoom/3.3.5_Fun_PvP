...
struct GroupQueueInfo                                       // stores information about the group in queue (also used when joined as solo!)
{
    ...
    bool    IsRated;                                        // rated
    bool    IsCustomSkirmish;                               // challenge script
    bool    IsSoloQueue;                                    // SoloQueue 2v2 
    uint8   ArenaType;                                      // 2v2, 3v3, 5v5 or 0 when BG // SoloQue
    ...
    uint8   DynamicMMRindex;								// for dynamic MMR Author: Tyrkysovej
};
...
class TC_GAME_API BattlegroundQueue
{
    public:
        ...
        bool CheckSolo2v2Arena(BattlegroundBracketId bracket_id);
