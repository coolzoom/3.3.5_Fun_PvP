...
bool BattlegroundDS::SetupBattleground()
{
    ...
    if (!AddObject(BG_DS_OBJECT_DOOR_1, BG_DS_OBJECT_TYPE_DOOR_1, 1350.95f, 817.2f, 20.8096f, 3.15f, 0, 0, 0.99627f, 0.0862864f, RESPAWN_IMMEDIATELY)
        ...
        // buffs
        || !AddObject(BG_DS_OBJECT_BUFF_1, BG_DS_OBJECT_TYPE_BUFF_1, 1321.54f, 760.71f, 3.45f, 4.64562f, 0, 0, 0.730314f, -0.683111f, 120) 
        || !AddObject(BG_DS_OBJECT_BUFF_2, BG_DS_OBJECT_TYPE_BUFF_2, 1261.37f, 820.31f, 3.45f, 1.55194f, 0, 0, 0.700409f, 0.713742f, 120)
        // knockback creatures
