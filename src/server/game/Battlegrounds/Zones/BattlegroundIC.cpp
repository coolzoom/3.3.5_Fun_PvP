...
void BattlegroundIC::EndBattleground(uint32 winner)
{
    ...
    if (winner == ALLIANCE)
    {
        std::string msg = "The Battle for Isle of Conquest, has been completed! Alliance win!";
        //sWorld->SendWorldText(LANG_BG_WIN_ANNOUNCE, msg.c_str());
    }
    else if (winner == HORDE)
    {
        std::string msg = "The Battle for Isle of Conquest, has been completed! Horde win!";
       // sWorld->SendWorldText(LANG_BG_WIN_ANNOUNCE, msg.c_str());
    }
