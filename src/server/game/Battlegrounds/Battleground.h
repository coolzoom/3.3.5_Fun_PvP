...
enum BattlegroundSpells
{
    ...
    SPELL_ARENA_PREPARATION_SOLO    = 32728,                // use this one, 32728 not correct
...
class TC_GAME_API Battleground
{
    public:
        ...
        void DespawnCrystals(GameObject* go);
        
        std::set<ObjectGuid> m_playersWantsFastStart;
