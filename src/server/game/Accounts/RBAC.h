...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_VIP_ARPPEAR                            = 1011,
        ...
        // arena spectator
    RBAC_PERM_COMMAND_SPECTATE                               = 1012,
    RBAC_PERM_COMMAND_SPECTATE_PLAYER                        = 1013,
    RBAC_PERM_COMMAND_SPECTATE_VIEW                          = 1014,
    RBAC_PERM_COMMAND_SPECTATE_RESET                         = 1015,
    RBAC_PERM_COMMAND_SPECTATE_LEAVE                         = 1016,
    
    RBAC_PERM_COMMAND_BADWORD                                = 1017,
    RBAC_PERM_COMMAND_BADWORD_MOD                            = 1018,
    RBAC_PERM_COMMAND_BADWORD_ADD                            = 1019,
    RBAC_PERM_COMMAND_BADWORD_REMOVE                         = 1020,
    RBAC_PERM_COMMAND_BADWORD_LIST                           = 1021,
    RBAC_PERM_COMMAND_RELOAD_BADWORD                         = 1022,
    
    RBAC_PERM_COMMAND_RELOAD_SPELL_DAMAGE                    = 1023,
    
    RBAC_PERM_COMMAND_COPY_GEAR                              = 1024,
    RBAC_PERM_COMMAND_COPY_TALENTS                           = 1025,
    RBAC_PERM_COMMAND_COPY_ALL                               = 1026,
    RBAC_PERM_COMMAND_COPY                                   = 1027,

    RBAC_PERM_COMMAND_ADDCOIN                                = 1028,
    
    RBAC_PERM_COMMAND_CHARACTER_STATS                        = 1029,
