...
enum SpellCustomAttributes
{
    ...
    SPELL_ATTR0_CU_CAN_RESIST                    = 0x00040000,
    SPELL_ATTR0_CU_ALLOW_INFLIGHT_TARGET         = 0x00080000,
    SPELL_ATTR0_CU_CANT_FADED                    = 0x00100000,   // Spells like Blind, Sap (Can't vanish) 
    SPELL_ATTR0_CU_AURA_CC                       = 0x00200000,   // CROWNDCONTROL AURAS
    SPELL_ATTR0_CU_NEEDS_AMMO_DATA               = 0x00400000,
