...
void Spell::EffectSchoolDMG(SpellEffIndex effIndex)
{
    ...
    if (unitTarget && unitTarget->IsAlive())
    {
        ...
        /*if (sWorld->getBoolConfig(CONFIG_CUSTOM_CUSTOMSYSTEM)) // its not work
        {
            // Custom SpellItem Fixes
            switch (m_spellInfo->Id)
            {
                case 24254: // Sceptre of Smiting
                    damage = urand(1433, 1888);
                    apply_direct_bonus = false;
                    break;
                case 24257:  // Jeklik's Crusher
                    damage = urand(3380, 4028);
                    apply_direct_bonus = false;
                    break; 
                case 24251: // Zulian Slicer
                    damage = urand(1386,1596);
                    apply_direct_bonus = false;
                    break;
                case 18205: // Arlokk's Grasp
                    damage = urand(1522, 1713);
                    apply_direct_bonus = false;
                    break;
                case 13440: // The Sun Eater
                    damage = urand(1713, 1927);
                    apply_direct_bonus = false;
                    break;
                case 26415: // Doom's Edge
                    damage = urand(2488, 3013);
                    apply_direct_bonus = false;
                    break;
                    // Trinketts
                case 29502: // Frost Arrow - Legendary Bow
                    damage = urand(3720, 4210);
                    apply_direct_bonus = false;
                    break;
                case 21140: // Draconic Avenger
                    damage = 3250;
                    apply_direct_bonus = false;
                    break;
                case 40293: // Syphon of the Nathrezim
                    damage = urand(770, 1288);
                    apply_direct_bonus = false;
                    break;
                case 41989: // Molten Fury - Fist weapons
                case 41990: // Molten Fury - Fist Weapon
                    damage = urand(1870, 2000);
                    apply_direct_bonus = false;
                    break;
                case 54757: // Hand-Mounted Pyro Rockets
                    damage = urand(3538, 4168);
                    apply_direct_bonus = false;
                    break;
                case 34696: // Glaive of the Pit
                    damage = urand(2375, 3325);
                    apply_direct_bonus = false;
                    break;
                // Custom Dung fixes    
                case 116: // Frostbolt Rank 1
                    apply_direct_bonus = false;
                    break;
                case 40253: // Molten Flames
                case 40263: // Molten Flames
                case 40255: // Molten Flames
                    damage = urand(6440, 7970);
                    apply_direct_bonus = false;
                    break;
                case 26168: // Fetish of Chitinous Spikes
                    damage = 644;
                    apply_direct_bonus = false;
                    break;
                case 23722: // Arcane Infused Gem
                    damage = urand(2766, 3314);
                    apply_direct_bonus = false;
                    break;
                case 41039: // Chaotic Retribution
                    damage = urand(4480, 6120);
                    if (m_caster)
                        if (Aura* aura = m_caster->GetAura(41033))
                            damage = damage + int32(damage * aura->GetStackAmount());
                    apply_direct_bonus = false;
                    break;
                    
                /////// BLACK MORASS //////
                case 36214: // Rift Lord - Thunderclap
                case 38537: // Rift Lord - Thunderclap
                    damage = urand(10000, 12410);
                    apply_direct_bonus = false;
                    break;
                case 9080: // Rift Lord - Hamstring
                    damage = urand(13714, 18410);
                    apply_direct_bonus = false;
                    break;
                case 31478: // Time keeper - Breath
                    damage = urand(23714, 28410);
                    apply_direct_bonus = false;
                    break;
                case 38533: // Rift Keeper - Shadow bolt volley
                case 36275:
                    damage = urand(9744, 12795);
                    apply_direct_bonus = false;
                    break;
                case 38536: // Rift Keeper - Blast Wave
                case 36278:
                    damage = urand(10000, 12000);
                    apply_direct_bonus = false;
                    break;
                case 38534: // Rift Keeper - Frostbolt
                case 36279:
                    damage = urand(13441, 20471);
                    apply_direct_bonus = false;
                    break;
                case 15497: // Infinity Chronomancer - Frost bolt
                case 12675: 
                case 15124: // -- Arcane Bolt
                case 15230:
                case 33860: // -- Arcane explosion
                case 33623:
                    damage = urand(8714, 10410);
                    apply_direct_bonus = false;
                    break;
                case 12739: // Infinity Vanquisher
                case 15472:
                case 13341: // -- Fireblast
                case 38526:
                    damage = urand(10714, 11410);
                    apply_direct_bonus = false;
                    break;
                case 15241: // -- Scorch
                case 36807:
                    damage = urand(5911, 7441);
                    apply_direct_bonus = false;
                    break;
                case 31457: // Chrono Lord Deja - Arcane Blast
                    damage = urand(16100, 22041);
                    apply_direct_bonus = false;
                    break; 
                case 38538: // -- Arcane Blast (H)
                    damage = urand(19100, 26041);
                    apply_direct_bonus = false;
                    break; 
                case 31472: // -- Arcane Discharge
                    damage = urand(12100, 14980);
                    apply_direct_bonus = false;
                    break; 
                case 38539: // -- Arcane Discharge (H)
                    damage = urand(15100, 17980);
                    apply_direct_bonus = false;
                    break; 
                case 31475: // Tamporus - Buffed Wings
                    damage = urand(12600, 15080);
                    apply_direct_bonus = false;
                    break; 
                case 38593: // -- Buffed Wings (H)
                    damage = urand(13600, 20080);
                    apply_direct_bonus = false;
                    break; 
                case 31473: // Aeonus - Sand Breath
                    damage = urand(19600, 22080);
                    apply_direct_bonus = false;
                    break; 
                case 39049: // - Sand Breath (H)
                    damage = urand(24600, 30080);
                    apply_direct_bonus = false;
                    break;            
            }
        }*/
        switch (m_spellInfo->SpellFamilyName)
        {
            case SPELLFAMILY_GENERIC:
            {
                ...
                switch (m_spellInfo->Id)                     // better way to check unknown
                {
                    case 34799:
                    {
                        damage = urand(8900,11200);
                        if (Aura* aura = m_caster->GetAura(34794))
                            damage = int32(damage * aura->GetStackAmount());
                         break;
                    }
                    case 51132: // Time Bomb
                    {
                        damage = 5200 + (m_caster->GetMaxHealth() - m_caster->GetHealth());
                        if (damage < 1000)
                            damage = 10000;
                         break;
                    }
            ...
            case SPELLFAMILY_WARRIOR:
            {
                ...
                if (m_spellInfo->SpellFamilyFlags[1] & 0x200 && m_spellInfo->GetCategory() == 1209)
                {
                    ...
                    uint32 block_value = m_caster->GetShieldBlockValue(uint32(float(level) * 31.5f), uint32(float(level) * 34.5f));
            ...
            case SPELLFAMILY_PALADIN:
            {
                ...
                {
                    uint8 level = m_caster->getLevel();
                    uint32 block_value = m_caster->GetShieldBlockValue(uint32(float(level) * 33.5f), uint32(float(level) * 39.5f));
        ...
        && effectHandleMode == SPELL_EFFECT_HANDLE_LAUNCH_TARGET)
    {
        ...
        switch (triggered_spell_id)
        {
            ...
            case 8690: // Hearthstone
            {
                ...
                if (m_caster->GetSpellHistory()->HasCooldown(8690))
                    m_caster->GetSpellHistory()->ResetCooldown(8690);
                break;
            }
            // Vanish (not exist)
            case 18461:
...
void Spell::EffectPowerBurn(SpellEffIndex effIndex)
{
    ...
    if (unitTarget && unitTarget->IsAlive() && unitTarget->GetTypeId() == TYPEID_UNIT && unitTarget->ToCreature()->IsTotem() && unitTarget->ToTotem()->HasAura(8179))
...
void Spell::EffectHeal(SpellEffIndex /*effIndex*/)
{
    ...
    if (unitTarget && unitTarget->IsAlive() && damage >= 0)
    {
        ...
        /*if (m_spellInfo->Id == 40293)
            addhealth += irand(760,1000);*/
            ...
            switch (properties->Type)
            {
                ...
                case SUMMON_TYPE_TOTEM:
                {
                    ...
                    if (m_spellInfo->Id == 16190)
                        damage = m_caster->CountPctFromMaxHealth(17.5f);
...
void Spell::EffectTameCreature(SpellEffIndex /*effIndex*/)
{
    ...
    uint8 level = 80;//(creatureTarget->getLevel() < (m_caster->getLevel() - 5)) ? (m_caster->getLevel() - 5) : creatureTarget->getLevel();
...
void Spell::EffectSummonPet(SpellEffIndex effIndex)
{
    ...
    if (OldSummon)
    {
        if ((petentry == 0 || OldSummon->GetEntry() == petentry) && OldSummon->getPetType() == HUNTER_PET)
        {
    ...
    switch (m_spellInfo->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_ROGUE:
        {
            ...
            else if (m_spellInfo->SpellFamilyFlags[1] & 0x6)
            {
                ...
                if (found)
                    totalDamagePercentMod *= 1.25f;          // 120% if poisoned
            }
            break;
        }
        case SPELLFAMILY_PALADIN:
            ...
            switch (m_spellInfo->Id)
            {
                ...
                case 58591: // Rank 10
                {
                    ...
                    if (AuraEffect* aur=unitTarget->GetAuraEffect(63298, 0))
                    {
                        ...
                        /*if (sWorld->getBoolConfig(CONFIG_CUSTOM_CUSTOMSYSTEM))
                            basepoints0 += 0.6f * m_caster->SpellBaseDamageBonusDone(m_spellInfo->GetSchoolMask());*/
...
void Spell::EffectLeap(SpellEffIndex /*effIndex*/)
{
   ...
   if (m_spellInfo && (m_spellInfo->Id == 1953) && m_caster && unitTarget && unitTarget->GetTypeId() == TYPEID_PLAYER)    // Blink
    {
        float dis = 21.5; //Distance +1.5 distance (Collision)
        if (m_caster->ToPlayer() && m_caster->HasAura(56365)) //Glyph of Blink
            dis += 5;
        ...
        unitTarget->GetPosition(cx, cy, cz);  // Start position

        bool useVmap = false;
        bool swapZone = true;
        if (VMAP::VMapFactory::createOrGetVMapManager()->isHeightCalcEnabled()) // Using VMap
            useVmap = true;

        // if fly (not on ground) calculate groundZ
        if (cz - m_caster->GetMap()->GetHeight(cx, cy, cz, useVmap) < 5)
            unitTarget->UpdateGroundPositionZ(cx, cy, cz);

        dz = cz;
        float bx, by, bz; // last fixed point
        bool air = false;

        for (float i = 0.5f; i<dis; i += 0.5f) // calculating every 0,5 yds
        {
            if (!air)
            {
                bx = cx;
...
void Spell::EffectCharge(SpellEffIndex /*effIndex*/)
{
    ...
    if (effectHandleMode == SPELL_EFFECT_HANDLE_LAUNCH_TARGET)
    {
        ...
        if (m_preGeneratedPath.GetPathType() == PATHFIND_BLANK)
        {
            ...
            Position pos = unitTarget->GetFirstCollisionPosition(0.1f, unitTarget->GetRelativeAngle(m_caster));
            m_caster->GetMotionMaster()->MoveCharge(pos.m_positionX, pos.m_positionY, pos.m_positionZ + 1.0f, speed);
        }
        else
