    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
		...
		for (uint8 j = 0; j < MAX_SPELL_EFFECTS; ++j)
        {
            switch (spellInfo->Effects[j].ApplyAuraName)
            {
                ...
                case SPELL_AURA_PERIODIC_DAMAGE_PERCENT:
                case SPELL_AURA_POWER_BURN:
                    if (spellInfo->Speed < 10)
                        spellInfo->AttributesCu |= SPELL_ATTR0_CU_CANT_FADED;
		...
		switch (spellInfo->Id)
		{
			...
			case 27223: // Death Coil
		        spellInfo->AttributesCu |= SPELL_ATTR0_CU_CAN_RESIST;
                break;
            case 49938: // Death and Decay
            case 48819: // Consecration
            case 52212: // D&A&D Trigger
            ...
            case 676: // Disarm (Warrior)
            case 64346: // Fiery Payback (Disarm Effect)
            case 53359: // Chimera Shot Disarm
            case 48300:
            case 64695: // Earthgrab
				spellInfo->AttributesCu |= SPELL_ATTR0_CU_CANT_FADED;
				break;
            case 21140: // Draconic Avengers
...
void SpellMgr::LoadSpellInfoCorrections()
{
    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            /*if (sWorld->getBoolConfig(CONFIG_CUSTOM_CUSTOMSYSTEM)) // its not work, tested commanding shot.
            {
                ///// CUSTOM UPDATES //////
                case 28730: // Arcane Torrent - Rogue
                case 25046: // Arcane Torrent - Mana
                case 50613: // Arcane Torrent - DK
                    spellInfo->Dispel = DISPEL_CURSE;
                    spellInfo->SchoolMask = SPELL_SCHOOL_MASK_NORMAL;
                    break;
                case 61851: // Killing Spree DMG
                    spellInfo->Effects[EFFECT_0].BasePoints *= 2.4f; // Split between two one hands and 20% bonus
                    break;
                case 26013: // Deserter
                    spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(5); // 5min?
                    break;
                // Will of Hakkar - ZG Spell
                case 24178: 
                    spellInfo->MaxTargetLevel = 85;
                    break;
                case 53480: // Roar of Sacrifice Split damage
                    spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS;
                    break;
                // Custom Updates
                case 55503: // Life bloom
                case 45544: //First Aid
                    spellInfo->Effects[EFFECT_0].BasePoints *= 1.75f;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 1.75f;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 1.75f;
                    break;
                case 53040: // Thougness
                    spellInfo->Effects[EFFECT_0].BasePoints *= 2.5f;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 2.5f;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 2.5f;
                case 33697: // Orc Racial
                    spellInfo->Effects[EFFECT_0].ValueMultiplier *= 2;
                    spellInfo->Effects[EFFECT_1].ValueMultiplier *= 2;
                    spellInfo->Effects[EFFECT_0].BonusMultiplier *= 2;
                    spellInfo->Effects[EFFECT_1].BonusMultiplier *= 2;
                    spellInfo->Effects[EFFECT_0].RealPointsPerLevel *= 2;
                    spellInfo->Effects[EFFECT_1].RealPointsPerLevel *= 2;
                    break;
                // Death Knight
                case 57623: // Horn of Winter
                // Hunter
                case 61847: // Aspect of DragonHawk
                // Paladin
                case 48932: // Blessing of Might
                case 48942: // Devotion Aura
                case 48934: // Greater Blessing of Might
                case 67:    // Vindictaion Rank 1
                case 26017: // Vindication Rank 2
                // Priest
                case 48168: // Inner Fire
                case 48161: // Power word Fortitude
                case 48162: // Prayer of Fortitude
                // Druid
                case 48469: // Mark of the Wild 
                case 48470: // Gift of the Wild
                // Shaman
                case 57663: // Totem of Wrath
                case 58754: // Totem of Stoneskin
                case 58646: // Totem of Strenght of Earth
                case 58792: // Flametongue Weapon
                ...
                // Mage
                case 43008: // Frost Armor
                case 43002: // Arcane Brilliance
                case 42995: // Arcane Intellect
                case 42987: // Mana Sapphire // Mana Gem - Mage
                // Warlock
                case 47877: // Healthstone // Warlock
                case 47876: // Healthstone // Warlock
                case 47875: // Healthstone // Warlock
                case 47986: // sacrifice (Warlock absorb from pet)
                case 47982: // Blood Pact
                case 57567: // Fel Intellect
                case 50511: // Curse of Weakness
                case 47893: // Fel Armor
                case 47889: // Demon Armor
                // RANDOM BOFFS
                case 57399: // Well Fed - Cookijng
                case 67019: // Flask of the North - All
                case 67018: // Flask of the North - Srength
                case 67017: // Flask of the North - Spell
                case 67016: // Flask of the North - ATP
                case 53755: // Flask of the Frost Wyrm
                case 53758: // Flask of the Stoneblood
                case 54212: // Flask of the Pure mojo
                case 53760: // Flask of the Endless Rage 
                    spellInfo->Effects[EFFECT_0].BasePoints *= 1.5f;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 1.5f;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 1.5f;
                    break;
                case 43183: // Food & Drink
                case 64356: // Food & Drink
                case 64355: // Food & Drink
                case 45548: // Food & Drink
                case 57073: // Food & Drink
                    spellInfo->Effects[EFFECT_0].BasePoints *= 1.15f;
                    break;
                /// Items Updated (WEapons) /////
                case 75466: // Charred Twilight Nightmare
                    spellInfo->Effects[EFFECT_0].BasePoints = 1108;
                    break;
                case 34747: // Charred Twilight Nightmare
                    spellInfo->Effects[EFFECT_0].BasePoints = 1603;
                    break;
                case 71605: // Charred Twilight Nightmare
                    spellInfo->Effects[EFFECT_0].BasePoints = 1448;
                    break;
                case 67596: // Battlemaster
                    spellInfo->Effects[EFFECT_0].BasePoints = 7500;
                    break;
                case 28144: // Zhar'doom, Greatstaff of the Devourer
                    spellInfo->Effects[EFFECT_0].BasePoints = 192;
                    spellInfo->Effects[EFFECT_1].BasePoints = 192;
                    spellInfo->Effects[EFFECT_2].BasePoints = 192;
                    spellInfo->AttributesEx3 |= SPELL_ATTR3_DEATH_PERSISTENT;
                    break;
                case 13526: // Shivering Felspine
                    spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(29);
                    spellInfo->Effects[EFFECT_0].BasePoints = 933;
                    spellInfo->Effects[EFFECT_1].BasePoints -= 3000;
                    spellInfo->AttributesEx4 |= SPELL_ATTR4_FIXED_DAMAGE;
                    break;
                case 23719: // Demonic's Edge
                    spellInfo->Effects[EFFECT_0].BasePoints *= 3;
                    break;
                case 21140: // Draconic Avengers
                    spellInfo->AttributesEx4 |= SPELL_ATTR4_FIXED_DAMAGE;
                    break;
                ///// Random trinkets (UPDATE) /////
                case 43713: // Ancient Aqir Artifact
                    spellInfo->Effects[EFFECT_0].BasePoints *= 4;
                    break;
                case 60302: // Meteorite Whetstone
                    spellInfo->Effects[EFFECT_0].BasePoints = 1066;
                    break;
                case 65012: // Royal Seal of Knight Llane
                    spellInfo->Effects[EFFECT_0].BasePoints = 550;
                    break;
                case 43712: // Hex Shrunken Head
                    spellInfo->Effects[EFFECT_0].BasePoints = 1288;
                    break;
                case 24610: // Nat Pagle's Broken Reel
                    spellInfo->Effects[EFFECT_0].BasePoints = 372;
                    spellInfo->Effects[EFFECT_1].BasePoints = 372;
                    spellInfo->Effects[EFFECT_2].BasePoints = 372;
                    break;
                case 65014: // Pyrite Infuser
                    spellInfo->Effects[EFFECT_0].BasePoints = 1880;
                    spellInfo->Effects[EFFECT_1].BasePoints = 1880;
                    spellInfo->Effects[EFFECT_2].BasePoints = 1880;
                    break;
                case 40408: // Bulwark of Azzinoth
                    spellInfo->Effects[EFFECT_0].BasePoints = 6000;
                    spellInfo->Effects[EFFECT_1].BasePoints = 6000;
                    spellInfo->Effects[EFFECT_2].BasePoints = 6000;
                    break;
                case 40396: // Skull of Gul'dan
                    spellInfo->Effects[EFFECT_0].BasePoints = 710;
                    break;
                case 32368: //Tome of the Lightbringer
                case 41038: // Idol of the White Stag
                case 41040: // Totem of ancestral guidance
                    spellInfo->Effects[EFFECT_0].BasePoints = 324;
                    spellInfo->Effects[EFFECT_1].BasePoints = 324;
                    spellInfo->Effects[EFFECT_2].BasePoints = 324;
                    break;
                case 40464: // Shadowmoon Insignia
                    spellInfo->Effects[EFFECT_0].BasePoints = 7500;
                    spellInfo->Effects[EFFECT_1].BasePoints = 7500;
                    spellInfo->Effects[EFFECT_2].BasePoints = 7500;
                    break;
                case 40972: // Crystal Spire of Karabor
                    spellInfo->Effects[EFFECT_0].BasePoints *= 7.5f;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 7.5f;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 7.5f;
                    break;
                case 34696: // Glaive of the Pit
                    spellInfo->Effects[EFFECT_0].BasePoints = 3000;
                    spellInfo->Effects[EFFECT_1].BasePoints = 3000;
                    break;
                case 40293: // Syphon of the Nathrezim
                    spellInfo->Effects[EFFECT_0].BasePoints = 922;
                    spellInfo->Effects[EFFECT_1].BasePoints = 488;
                    break;
                case 40477: // madness of the Betrayer
                    spellInfo->Effects[EFFECT_0].BasePoints = 690;
                    spellInfo->Effects[EFFECT_1].BasePoints = 690;
                    spellInfo->Effects[EFFECT_2].BasePoints = 690;
                    break;
                case 71558: // Deathbringer Justice Strenght
                case 71561: // Deathbringer Justice Attp
                    spellInfo->Effects[EFFECT_0].BasePoints *= 1.2f;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 1.2f;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 1.2f;
                    break;
                case 71600: // Dislodged lost object
                case 41435: // Twin Azzinoth Bonus
                    spellInfo->Effects[EFFECT_0].BasePoints *= 1.5f;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 1.5f;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 1.5f;
                    break;
                case 37656: // Memento of Tyrande
                    spellInfo->Effects[EFFECT_0].BasePoints = 396;
                    spellInfo->Effects[EFFECT_1].BasePoints = 396;
                    spellInfo->Effects[EFFECT_2].BasePoints = 396;
                    break;
                case 60526: // Bauble of Perfection
                    spellInfo->Effects[EFFECT_0].BasePoints = 12400;
                    spellInfo->Effects[EFFECT_1].BasePoints = 12400;
                    spellInfo->Effects[EFFECT_2].BasePoints = 12400;
                    break;
                case 75458: // Sharpened Darknest scale
                    spellInfo->Effects[EFFECT_0].BasePoints = 1794;
                    spellInfo->Effects[EFFECT_1].BasePoints = 1794;
                    spellInfo->Effects[EFFECT_2].BasePoints = 1794;
                    break;
                case 29506: // Burrow's Shell
                    spellInfo->Effects[EFFECT_0].BasePoints = 9800;
                    break;
                case 71570: // Muradin's vagiclean
                case 71575: // Unidentifiable Object
                    spellInfo->Effects[EFFECT_0].BasePoints *= 2;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 2;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 2;
                    break;
                //// ZG & DEADMINES .. ///////
                case 24575: // Zandalarian Hero Badge
                    spellInfo->Effects[EFFECT_0].BasePoints *= 8;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 8;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 8;
                    break;
                case 24662: //Zandalarian Hero Medallion
                    spellInfo->Effects[EFFECT_0].BasePoints *= 16;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 16;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 16;
                    break;
                case 24659: // Zandalarian Hero Charm
                    spellInfo->Effects[EFFECT_0].BasePoints *= 8;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 8;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 8;
                    break;
                case 24268: // // Mar'li's Eye
                    spellInfo->Effects[EFFECT_0].BasePoints = 449;
                    spellInfo->Effects[EFFECT_1].BasePoints = 449;
                    break;
                case 24255: // Fistweapon Primal Blessing
                    spellInfo->Effects[EFFECT_0].BasePoints = 920;
                    spellInfo->Effects[EFFECT_1].BasePoints = 920;
                    break;
                    
                case 24585: // HACKFIX: ITEM Hakkari Manslayer
                    spellInfo->Effects[EFFECT_0].BasePoints *= 28;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 28;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 28;
                    break;
                case 28204: // Talisman of Ascendance
                    spellInfo->Effects[EFFECT_0].BasePoints = 362;
                    spellInfo->Effects[EFFECT_1].BasePoints = 362;
                    spellInfo->Effects[EFFECT_2].BasePoints = 362;
                    break;
                case 16406: // Hameya's slayer
                    spellInfo->Effects[EFFECT_0].BasePoints *= 30;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 30;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 30;
                    break;
                case 33648: // Mirror of Truth
                    spellInfo->Effects[EFFECT_0].BasePoints = 1793;
                    spellInfo->Effects[EFFECT_1].BasePoints = 1793;
                    spellInfo->Effects[EFFECT_2].BasePoints = 1793;
                    break;
                case 60054: // Valor Medal of the First War
                case 60065: // Proc Ev.
                    spellInfo->Effects[EFFECT_0].BasePoints *= 2.33;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 2.33;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 2.33;
                    break;
                case 60063: //Sundial of the Exiled
                case 60064: // Now is the Time proc ev.
                    spellInfo->Effects[EFFECT_0].BasePoints *= 2.62;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 2.62;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 2.62;
                    break;
                case 33953: // The Egg of Mortal Essence
                case 60062: // Proc Ev.
                    spellInfo->Effects[EFFECT_0].BasePoints = 824;
                    spellInfo->Effects[EFFECT_1].BasePoints = 824;
                    spellInfo->Effects[EFFECT_2].BasePoints = 824;
                    break;
                // *** BOJ ITEMS & AZUREGOS *** ///
                case 38317: // Blade of Wizardry
                    spellInfo->Effects[EFFECT_0].BasePoints = 760;
                    break;
                case 26463: // Petrified Scarab
                    spellInfo->Effects[EFFECT_0].BasePoints = 450;
                    spellInfo->Effects[EFFECT_1].BasePoints = 45;
                    break;
                case 21153: // Bonereaver's Edge
                    spellInfo->Effects[EFFECT_0].BasePoints = 120;
                    break;
                case 45058: // Commendation of Kael'thas
                    spellInfo->Effects[EFFECT_0].BasePoints = 918;
                    break;
                case 13528: // Sword of Decay
                    spellInfo->Effects[EFFECT_0].BasePoints = -300;
                    break;
                case 36111: // World Breaker
                    spellInfo->Effects[EFFECT_0].BasePoints = 2000;
                    break;
                case 11791: // Vibroblade
                    spellInfo->Effects[EFFECT_0].BasePoints = -2000;
                    break;
                case 58157: // Solarian's Sapphire
                    spellInfo->Effects[EFFECT_0].BasePoints = 550;
                    break;
                case 37445: // Mana Surge - Trinket Mana Gem
                    spellInfo->Effects[EFFECT_0].BasePoints = 1346;
                    break;
                case 37198: // Tome of Fiery Redemption 
                    spellInfo->Effects[EFFECT_0].BasePoints = 1516;
                    break;
                case 23780: // Aegis of Preservation
                    spellInfo->Effects[EFFECT_0].BasePoints = 5000;
                    break;
                case 23781: // Aegis of Preservation
                    spellInfo->Effects[EFFECT_0].BasePoints = 550;
                    break;
                case 34241: // Idol of Feral Shadows
                    spellInfo->Effects[EFFECT_0].BasePoints = 83;
                    break;
                case 37737: // Idol of the Crescent Goddess
                    spellInfo->Effects[EFFECT_0].BasePoints = -491;
                    break;
                case 27847: // Libram of Grace
                    spellInfo->Effects[EFFECT_0].BasePoints = -108;
                    break;
                case 34246: // Idol of the Emerald Queen
                    spellInfo->Effects[EFFECT_0].BasePoints = 306;
                    break;
                case 34230: // Totem of the Void
                    spellInfo->Effects[EFFECT_0].BasePoints = 569;
                    break;
                case 34324: // Idol of the Claw
                    spellInfo->Effects[EFFECT_0].BasePoints *= 18;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 18;
                    break;
                case 34244: // Totem of the Astral Winds
                    spellInfo->Effects[EFFECT_0].BasePoints = 709;
                    break;
                case 34260: // Libram of Avengement
                    spellInfo->Effects[EFFECT_0].BasePoints = 336;
                    break;
                case 34292: // Ivory Idol of the Moongoddess
                    spellInfo->Effects[EFFECT_0].BasePoints = 569;
                    break;
                case 60828: // Sigil of Haunted Dreams
                    spellInfo->Effects[EFFECT_0].BasePoints = 336;
                    break;
                case 62146: // Sigil of the Unfaltering Knight
                    spellInfo->Effects[EFFECT_0].BasePoints = 192;
                    break;
                // DUNG UPDATES
                case 34794: // Arcane resonance - Zul Gurub
                    spellInfo->Effects[EFFECT_0].BasePoints = 3600;
                    spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(29); // 16sec
                    break;
                case 40481: // Acidic Spray - Black Temple
                    spellInfo->Effects[EFFECT_0].BasePoints *= 4;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 4;
                    break;
                case 41303: // Essence - Soul Drain - Black Temple
                    spellInfo->MaxAffectedTargets = 3;
                case 41337: // Essence - Frenzy Aura - Black Temple
                    spellInfo->Effects[EFFECT_0].BasePoints *= 3;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 2.5f;
                    break;
                case 41431: // Essence - Rune Shield - Black Temple
                    spellInfo->Effects[EFFECT_0].BasePoints *= 4;
                    break; 
                case 41545: // Essence - Rune Shield - Black Temple
                case 40861: // Mother - SPELL_BEAM_WICKED - Black temple
                    spellInfo->MaxAffectedTargets = 10;
                    spellInfo->Effects[EFFECT_0].BasePoints *= 5;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 3;
                    break;
                case 13787: // Deathshaper - Demon Armor - Black Temple 
                    spellInfo->Effects[EFFECT_0].BasePoints *= 5;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 5;
                    spellInfo->Effects[EFFECT_2].BasePoints *= 5;
                    break;
                case 41371: // Sister of Pain - In Combat - Cast 'Shell of Pain' - Black temple
                    spellInfo->Effects[EFFECT_1].BasePoints *= 5;
                    break;
                case 40871:  // Mother Shahraz - Attraction - Black Temple
                    spellInfo->Effects[EFFECT_0].BasePoints *= 5.3f;
                    break;
                case 41373: // Illidari Archon - In Combat - Cast 'Power Word: Shield' (No Repeat) - Black temple
                case 41475: // Reflective Shield - Council - Black temple
                    spellInfo->Effects[EFFECT_0].BasePoints = 200000;
                    break;
                case 41453: // Resistance Aura - Council - Black Temple
                case 41452: // Devoution Aura - Council - Black Temple
                    spellInfo->Effects[EFFECT_0].BasePoints *= 1.5f;
                    break;
                case 40904: // Draw Soul - Illidan - Black Temple
                    spellInfo->Effects[EFFECT_0].BasePoints *= 4;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 4;
                    break;
                case 30757: // Colfragnate - Magteridon
                    spellInfo->Effects[EFFECT_0].BasePoints = 7000;
                    break;
                case 21097: // Azuregos - Mana Storm
                    spellInfo->Effects[EFFECT_0].BasePoints *= 16;
                    spellInfo->Effects[EFFECT_1].BasePoints *= 15;
                    break;
                case 23537: // Azuregos - Enrage
                    spellInfo->Effects[EFFECT_0].BasePoints *= 35;
                    break;
                // Black Morass
                case 16145: // Pit Lord - Armor Reduction
                    spellInfo->Effects[EFFECT_0].BasePoints *= 5;
                    break;
                case 38535: // Rift keeper - Pyroblast
                case 36277:
                    spellInfo->Effects[EFFECT_0].BasePoints *= 8;
                    spellInfo->Effects[EFFECT_0].BasePoints *= 8;
                    break;
                case 14874: // Infinite Creeps - Rapture
                case 15583: // -- Rapture
                case 38520: // -- Deadly Poison
            ...
            case 8690: // HS
                ...
                break;
            /// NON CUSTOM UPDATES /////
            case 43995: // Tiny vodoo mask
                spellInfo->AttributesEx4 |= SPELL_ATTR4_USABLE_IN_ARENA;
            ...
            case 28405: // Knockback
				spellInfo->Effects[EFFECT_0].MiscValueB = 20;
			    break;
			case 34490: // Silencing Shot Wrong Speed
            case 18498: // Gab Order - Silenced
            case 74347: // Gab Order - Silenced
            case 61384: //Typhoon
            case 53227: // Typhoon
            ...
            case 1543 : //Flare
                ...
                spellInfo->Effects[EFFECT_1].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_7_YARDS);
                break;
            ...
            case 42867:
				spellInfo->Speed = 0.0f;
                spellInfo->Effects[EFFECT_0].MiscValueB = 0.0f;
				break;
            ...
            case 36350: // They Must Burn Bomb Aura (self)
                ...
                break;
            case 10092: // Sand Storm
            case 43528: // Sand Storm
            ...
            case 74396: // Fingers of Frost visual buff
                ...
                spellInfo->ProcCharges = 100; // Stack up to 5 times
                spellInfo->StackAmount = 100; // Stack up to 5 times
                break;
            ...
            case 58655: // Flametongue Totem rank 8 (Aura)
				...
				//spellInfo->Effects[EFFECT_0].BasePoints *= 1.66; // CUSTOM CUSTOM CUSTOM !!!
                break;
        ...
        switch (spellInfo->Id)
        {
			...
			case 49560: // Death Grip (trigger)
            case 70460: // Coldflame jets (Fixed problem with Frost freeze Traps)
                spellInfo->AttributesEx2 |= SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS;
				break;
			case 56488: // Sapper Charge Cloaking
            ...
            case 63675: // Devour plague (Talent Damage trigger) can't reflect
            case 63311: // Shadow Flame Glyph - TempFix for reflect
            case 61290: // Shadow Flame - TempFix for reflect
                spellInfo->AttributesEx |= SPELL_ATTR1_CANT_BE_REFLECTED;
                break;
            /*case 47496: // Corpse explosion Correct fix (its not hack)
                spellInfo->AttributesEx4 |= SPELL_ATTR4_FIXED_DAMAGE; 
            ...
            case 2094: // Blind
            case 33619: // PW:S Reflective Shield
            case 53601: // Wandering Plague
            case 34709: // Sight
                spellInfo->AttributesEx3 |= SPELL_ATTR3_NO_INITIAL_AGGRO;
                break;
            default:
