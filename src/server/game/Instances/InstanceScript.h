...
class TC_GAME_API InstanceScript : public ZoneScript
{
    public:
        ...
        // Returns completed encounters on readable format for printing
        uint32 GetCompletedEncountersReadable() const;

        // Returns total encounters on readable format for printing
        uint32 GetTotalEncountersReadable() const;
