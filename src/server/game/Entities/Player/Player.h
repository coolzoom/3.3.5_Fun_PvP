...
#include "../../../scripts/Custom/Player_transmogrifier/Transmogrification.h"
#include "../../../scripts/Custom/Player_transmogrifier/TransmogDisplayVendorConf.h"
...
enum CharacterPrimarySpec
{
    PRIMARY_SPEC_NONE                                = 0,
    PRIMARY_SPEC_LEFT                                = 1, // The left talent specialization
    PRIMARY_SPEC_MIDDLE                              = 2, // The middle talent specialization
    PRIMARY_SPEC_RIGHT                               = 3  // The right talent specialization
};

enum CharacterPossibleRole
{
    CHARACTER_ROLE_NONE                              = 0,
    CHARACTER_ROLE_TANK                              = 1,
    CHARACTER_ROLE_HEAL                              = 2,
    CHARACTER_ROLE_DPS                               = 3
};
...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    private:
        ...
        uint8 m_RealRace;
    public:
        typedef std::vector<ObjectGuid> FakePlayers;
        ...
        static bool BuildCustomEnumData(PreparedQueryResult result, WorldPacket* data);
        ...
        CustomSkirmishStatus getSkirmishStatus(uint8 type) { return skirmishStatus[type]; }
        void setSkirmishStatus(uint8 type, CustomSkirmishStatus status) { skirmishStatus[type] = status; }
        ...
        void LoadItemTemplateQuery(int32 level, ItemTemplate const* pProto);
        ...
        bool AddItem(uint32 itemId, uint32 count, int32 CItemLevel = 0);
        ...
        uint32 GetMaxPersonalArenaRatingRequirement(uint32 minarenaslot, bool alsoSolo = true) const;
        ...
        void _ApplyItemBonuses(ItemTemplate const* proto, Item* item, uint8 slot, bool apply, bool only_level_scale = false);
        void _ApplyWeaponDamage(uint8 slot, ItemTemplate const* proto, Item* item, ScalingStatValuesEntry const* ssv, bool apply);
        ...
        int32 GetHighestArenaRating(uint8 type, bool update = false);
        ...
        float GetGearScore();
        CharacterPrimarySpec GetPrimarySpec();
        CharacterPossibleRole GetPossibleRole();
        ...
        bool CreateRecentActivity(int8 type, int32 id, int32 count = 0);
    ...
    protected:
        ...
        */
        ...
        int32 playerHighestRating[3]; // 3 Brackets
