...
class TC_GAME_API Creature : public Unit, public GridObject<Creature>, public MapObject
{
    public:
        ...
        bool IsUsingPath() const { return GetCreatureTemplate()->UsingMmaps == 1; }
        ...
        // Execute Event TRYING by saqirm
        bool ExecuteSpellEvent(Unit* target, SpellInfo const* spell);

        SpellInfo const* ExecuteSpell = NULL;
        Unit* ExecuteVictim = NULL;
