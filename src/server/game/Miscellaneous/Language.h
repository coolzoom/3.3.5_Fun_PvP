...
enum TrinityStrings
{
    ...
    //custom warden ban announce:: Example (Account [NAME] has been banned by.. etc etc
    SERVER_WARDEN_BAN_ANNOUNCE          = 365,
...
//                                      = 716, see LANG_PINFO_ACC_LASTLOGIN
    ...
    LANG_ARENA_QUEUE_ANNOUNCE_WORLD_SOLO= 719,
...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_ANNOUNCE_CHEST_WIN             = 788,
    LANG_ARENA_QUEUE_ANNOUNCE_WORLD_EXIT                = 789,
    LANG_ARENA_QUEUE_ANNOUNCE_WORLD_EXIT_SOLO           = 790,
    ...
    LANG_BG_WIN_ANNOUNCE                = 20201,

    LANG_BAN_CHEATER                    = 20202,
    // Show Kick in world
    ...
    // Info Commands
    // ->Player
    LANG_INFO_PLAYER_UPPER_BAR          = 11300,
    LANG_INFO_PLAYER_NAME               = 11301,
    LANG_INFO_PLAYER_GUILD              = 11302,
    LANG_INFO_PLAYER_CLASS_SPEC         = 11303,
    LANG_INFO_PLAYER_TALENT_DISTRIB     = 11304,
    LANG_INFO_PLAYER_POSSIBLE_ROL       = 11305,
    LANG_INFO_PLAYER_TOTAL_GS           = 11306,
    LANG_INFO_PLAYER_EQUIPPED_ILVL      = 11307,
    LANG_INFO_PLAYER_MMR                = 11308,
    LANG_INFO_PLAYER_WOWREAN            = 11309,
    LANG_INFO_PLAYER_LOWER_BAR          = 11310,
    // ->Raid
    LANG_INFO_RAID_UPPER_BAR            = 11311,
    LANG_INFO_RAID_ID                   = 11312,
    LANG_INFO_RAID_NAME_DIFFICULTY      = 11313,
    LANG_INFO_RAID_PROGRESS             = 11314,
    LANG_INFO_RAID_LEADER               = 11315,
    LANG_INFO_RAID_COMPOSITION          = 11316,
    LANG_INFO_RAID_ROLES                = 11317,
    LANG_INFO_RAID_AVG_GS               = 11318,
    LANG_INFO_RAID_AVG_ILVL             = 11319,
    LANG_INFO_RAID_WOWREAN              = 11320,
    LANG_INFO_RAID_LOWER_BAR            = 11321,

    LANG_LIST_RAID_UPPER_BAR            = 11322,
    LANG_LIST_RAID_PLAYER               = 11323,
    LANG_LIST_RAID_ACTIVE               = 11324,
    LANG_LIST_RAID_INACTIVE             = 11325,
    LANG_LIST_RAID_WOW                  = 11326,
    LANG_LIST_RAID_LOWER_BAR            = 11327,
    ...
    // Vas autobalance 
    LANG_VAS_BALANCE_JOIN                         = 11119,
    LANG_VAS_BALANCE_LEFT                         = 11120,
    
    // Mail antispam
    LANG_ANTISPAM_ERROR                           = 11123,

    //WG WG Announce
    LANG_WG_ANNOUNCE_WORLD                        = 11124,
    LANG_WG_ANNOUNCE15_WORLD                      = 11125,
    
    // Item reward
    LANG_REWARD_SERVER_ITEM                       = 11126,
    
    // World Filter
    LANG_WORD_FILTER_FOUND_BAD_WORD_IN_CHAT       = 11127,
    LANG_WORD_FILTER_FOUND_BAD_WORD_IN_MAIL       = 11128,
	LANG_WORD_FILTER_BADCHAT_SENDGM_IN_CHAT       = 11129,
    
    LANG_PLAYER_TIME_REWARD                       = 10001
};
#endif
