...
enum WorldBoolConfigs
{
    ...
    CONFIG_SOLO_2V2_ENABLE,
    CONFIG_SOLO_2V2_FILTER_TALENTS,
    CONFIG_SOLO_2V2_VENDOR_RATING,
    CONFIG_ARENA_CHECK_EQUIP_AND_TALENTS,
    CONFIG_ARENA_1V1_BLOCK_FORBIDDEN_TALENTS,
    CONFIG_SOLO_2V2_CAST_DESERTER_ON_AFK,
    CONFIG_SOLO_2V2_CAST_DESERTER_ON_LEAVE,
    CONFIG_SOLO_2V2_STOP_GAME_INCOMPLETE,
    CONFIG_SOLO_3V3_IP_CHECK,
    CONFIG_SOLO_3V3_TIME_CHECK,
    CONFIG_SOLO_3V3_REWARD,
    CONFIG_CUSTOM_CUSTOMSYSTEM,
...
enum WorldFloatConfigs
{
    ...
    CONFIG_VAS_XPlAYER,
    CONFIG_VAS_MIN_DAMAGE_MOD,
    CONFIG_VAS_MIN_HP_MOD,
...
enum WorldIntConfigs
{
    ...
    CONFIG_PORT_WORLD,
    CONFIG_SOLO_2V2_COSTS,
    CONFIG_SOLO_2V2_MIN_LEVEL,
    ...
    CONFIG_SOLO_3V3_REWARD_1V1,
    CONFIG_SOLO_3V3_REWARD_1V1_COUNT,
    CONFIG_SOLO_3V3_REWARD_3V3, 
    CONFIG_SOLO_3V3_REWARD_3V3_COUNT,
    CONFIG_SOLO_3V3_REWARD_HEALER, 
    CONFIG_SOLO_3V3_REWARD_HEALER_COUNT,
    CONFIG_SOLO_3V3_REWARD_2V2, 
    CONFIG_SOLO_3V3_REWARD_2V2_COUNT, 
    CONFIG_SOLO_3V3_REWARD_2V2_LOS, 
    CONFIG_SOLO_3V3_REWARD_2V2_LOS_COUNT,
    CONFIG_SOLO_3V3_REWARD_LOS, 
    CONFIG_SOLO_3V3_REWARD_LOS_COUNT,
    CONFIG_VAS_AUTOINSTANCE,
    CONFIG_VAS_PLAYER_CHANGE_NOFITY,
    CONFIG_AWARDS_PER_TIME_1_HOURS,
    CONFIG_AWARDS_PER_TIME_3_HOURS,
    CONFIG_AWARDS_PER_TIME_6_HOURS,
    CONFIG_AWARDS_PER_TIME_12_HOURS,
    CONFIG_AWARDS_PER_TIME_1_DAY,
    CONFIG_AWARDS_PER_TIME_2_DAY,
    CONFIG_AWARDS_PER_TIME_4_DAY,
    CONFIG_AWARDS_PER_TIME_8_DAY,
    CONFIG_AWARDS_PER_TIME_16_DAY,
    CONFIG_AWARDS_PER_TIME_30_DAY,
    CONFIG_AWARDS_PER_TIME_1_HOURS_COUNT,
    CONFIG_AWARDS_PER_TIME_3_HOURS_COUNT,
    CONFIG_AWARDS_PER_TIME_6_HOURS_COUNT,
    CONFIG_AWARDS_PER_TIME_12_HOURS_COUNT,
    CONFIG_AWARDS_PER_TIME_1_DAY_COUNT,
    CONFIG_AWARDS_PER_TIME_2_DAY_COUNT,
    CONFIG_AWARDS_PER_TIME_4_DAY_COUNT,
    CONFIG_AWARDS_PER_TIME_8_DAY_COUNT,
    CONFIG_AWARDS_PER_TIME_16_DAY_COUNT,
    CONFIG_AWARDS_PER_TIME_30_DAY_COUNT,
...
class TC_GAME_API World
{
    public:
        ...
        std::string GetVAS40() const { return CONFIG_VAS_AUTOBALANCE_40_NAME; }
        std::string GetVAS25() const { return CONFIG_VAS_AUTOBALANCE_25_NAME; }
        std::string GetVAS20() const { return CONFIG_VAS_AUTOBALANCE_20_NAME; }
        std::string GetVAS10() const { return CONFIG_VAS_AUTOBALANCE_10_NAME; }
        std::string GetVAS5() const { return CONFIG_VAS_AUTOBALANCE_5_NAME; }
        std::string GetVAS2() const { return CONFIG_VAS_AUTOBALANCE_2_NAME; }
        ...
        void SendMessageInNameChannel(std::string channel_name, std::string message);
    ...
    private:
        ...
        std::string CONFIG_VAS_AUTOBALANCE_40_NAME;
        std::string CONFIG_VAS_AUTOBALANCE_25_NAME;
        std::string CONFIG_VAS_AUTOBALANCE_20_NAME;
        std::string CONFIG_VAS_AUTOBALANCE_10_NAME;
        std::string CONFIG_VAS_AUTOBALANCE_5_NAME;
        std::string CONFIG_VAS_AUTOBALANCE_2_NAME;
        std::string CONFIG_VAS_COLOR;

        uint32 m_CleaningFlags;

        bool m_isClosed;
		int cache2v2Queue[MAX_TALENT_CAT];
