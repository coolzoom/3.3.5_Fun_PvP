...
#include "../../../scripts/Custom/npc_solo_queue.h"
#include "Arena.h"
#include "M2Stores.h"
...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_ALLOW_TWO_SIDE_INTERACTION_CHANNEL] = sConfigMgr->GetBoolDefault("AllowTwoSide.Interaction.Channel", true);
    m_bool_configs[CONFIG_ALLOW_TWO_SIDE_INTERACTION_GROUP]   = sConfigMgr->GetBoolDefault("AllowTwoSide.Interaction.Group", true);
    m_bool_configs[CONFIG_ALLOW_TWO_SIDE_INTERACTION_GUILD]   = sConfigMgr->GetBoolDefault("AllowTwoSide.Interaction.Guild", true);
    ...
    m_bool_configs[CONFIG_ALLOW_TWO_SIDE_TRADE]               = sConfigMgr->GetBoolDefault("AllowTwoSide.Trade", true);
    ...
    m_bool_configs[CONFIG_START_ITEMS]       = sConfigMgr->GetBoolDefault("StartPlayerItems", false);
    ...
    std::string s_pvp_ranks = sConfigMgr->GetStringDefault("PvPRank.HKPerRank", "20,40,80,100,200,400,600,800,1000,2000,3000,4000,5000,10000");
    ...
    m_int_configs[CONFIG_CHATFLOOD_CAPS_LENGTH] = sConfigMgr->GetIntDefault("ChatFlood.CMessageLength", 100);
    m_int_configs[CONFIG_CHATFLOOD_CAPS_PCT] = sConfigMgr->GetIntDefault("ChatFlood.CMessagePct", 70);
    m_int_configs[CONFIG_CHATFLOOD_REPEAT_MESSAGES] = sConfigMgr->GetIntDefault("ChatFlood.RepeatMessages", 5);
    m_int_configs[CONFIG_CHATFLOOD_REPEAT_TIMEOUT] = sConfigMgr->GetIntDefault("ChatFlood.RepeatTimeOut", 10);
    m_int_configs[CONFIG_CHATFLOOD_REPEAT_MUTE] = sConfigMgr->GetIntDefault("ChatFlood.RepeatMute", 20);
    m_int_configs[CONFIG_CHATFLOOD_CHATTYPE] = sConfigMgr->GetIntDefault("ChatFlood.ChatType", 1);
    m_int_configs[CONFIG_CHATFLOOD_EMOTE_COUNT] = sConfigMgr->GetIntDefault("ChatFlood.EmoteCount", 5);
    m_int_configs[CONFIG_CHATFLOOD_EMOTE_DELAY] = sConfigMgr->GetIntDefault("ChatFlood.EmoteDelay", 5);
    ...
    m_bool_configs[CONFIG_SOLO_2V2_ENABLE]                           = sConfigMgr->GetBoolDefault("Solo.3v3.Enable", true);
    m_int_configs[CONFIG_SOLO_2V2_MIN_LEVEL]                         = sConfigMgr->GetIntDefault("Solo.3v3.MinLevel", 80);
    m_int_configs[CONFIG_SOLO_2V2_COSTS]                             = sConfigMgr->GetIntDefault("Solo.3v3.Costs", 0);
    m_bool_configs[CONFIG_SOLO_2V2_FILTER_TALENTS]                   = sConfigMgr->GetBoolDefault("Solo.3v3.Filter.Talents", true);
    m_bool_configs[CONFIG_SOLO_2V2_VENDOR_RATING]                    = sConfigMgr->GetBoolDefault("Solo.3v3.Vendor.Rating", true);
    m_bool_configs[CONFIG_ARENA_1V1_BLOCK_FORBIDDEN_TALENTS]         = sConfigMgr->GetBoolDefault("Solo.3v3.Block.ForbiddenTalents", true);
    m_bool_configs[CONFIG_ARENA_CHECK_EQUIP_AND_TALENTS]             = sConfigMgr->GetBoolDefault("Solo.3v3.Check.Equip.And.Talents", true);
    m_bool_configs[CONFIG_SOLO_2V2_CAST_DESERTER_ON_AFK]             = sConfigMgr->GetBoolDefault("Solo.3v3.Cast.Deserter.On.Afk", true);
    m_bool_configs[CONFIG_SOLO_2V2_CAST_DESERTER_ON_LEAVE]           = sConfigMgr->GetBoolDefault("Solo.3v3.Cast.Deserter.On.Leave", true);
    m_bool_configs[CONFIG_SOLO_2V2_STOP_GAME_INCOMPLETE]             = sConfigMgr->GetBoolDefault("Solo.3v3.Stop.Game.Incomplete", true);
    m_bool_configs[CONFIG_SOLO_3V3_IP_CHECK]                         = sConfigMgr->GetBoolDefault("Solo.3v3.Ip.Check", false);
    m_bool_configs[CONFIG_SOLO_3V3_TIME_CHECK]                       = sConfigMgr->GetBoolDefault("Solo.3v3.Time.Check", false);
    m_bool_configs[CONFIG_SOLO_3V3_REWARD]                           = sConfigMgr->GetBoolDefault("Solo.3v3.Reward", false);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_1V1]                        = sConfigMgr->GetIntDefault("Solo.3v3.Reward.1v1.Winner", 49426);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_1V1_COUNT]                  = sConfigMgr->GetIntDefault("Solo.3v3.Reward.1v1.Count", 1);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_2V2]                        = sConfigMgr->GetIntDefault("Solo.3v3.Reward.2v2.Winner", 49426);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_2V2_COUNT]                  = sConfigMgr->GetIntDefault("Solo.3v3.Reward.2v2.Count", 1);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_2V2_LOS]                    = sConfigMgr->GetIntDefault("Solo.3v3.Reward.2v2.Los", 49426);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_2V2_LOS_COUNT]              = sConfigMgr->GetIntDefault("Solo.3v3.Reward.2v2.Los.Count", 1);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_3V3]                        = sConfigMgr->GetIntDefault("Solo.3v3.Reward.3v3.Winner", 49426);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_3V3_COUNT]                  = sConfigMgr->GetIntDefault("Solo.3v3.Reward.3v3.Count", 1);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_HEALER]                     = sConfigMgr->GetIntDefault("Solo.3v3.Reward.Healer", 49426);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_HEALER_COUNT]               = sConfigMgr->GetIntDefault("Solo.3v3.Reward.Healer.Count", 1);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_LOS]                        = sConfigMgr->GetIntDefault("Solo.3v3.Reward.Los", 49426);
    m_int_configs[CONFIG_SOLO_3V3_REWARD_LOS_COUNT]                  = sConfigMgr->GetIntDefault("Solo.3v3.Reward.Los.Count", 1);
     
    m_bool_configs[CONFIG_CUSTOM_CUSTOMSYSTEM]                       = sConfigMgr->GetBoolDefault("Custom.CustomSystem", false);
    ...
    VisualCharName = sConfigMgr->GetStringDefault("VisualCharacterName", "Config not correctly set.");
    m_bool_configs[CONFIG_VISUAL_CHAR_ENABLED] = sConfigMgr->GetBoolDefault("EnableVisualCharacter", false);
    m_int_configs[CONFIG_VISUAL_CHAR_CHEST] = sConfigMgr->GetIntDefault("VisualCharacter.Chest", 10036);
    m_int_configs[CONFIG_VISUAL_CHAR_BODY] = sConfigMgr->GetIntDefault("VisualCharacter.Shirt", 10034);
    m_int_configs[CONFIG_VISUAL_CHAR_HEAD] = sConfigMgr->GetIntDefault("VisualCharacter.Head", 19945);
    m_int_configs[CONFIG_VISUAL_CHAR_LEGS] = sConfigMgr->GetIntDefault("VisualCharacter.Legs", 10035);
    m_int_configs[CONFIG_VISUAL_CHAR_FEET] = sConfigMgr->GetIntDefault("VisualCharacter.Feet", 840);
    ...
    m_bool_configs[CONFIG_VIP_BANK_COMMAND] = sConfigMgr->GetBoolDefault("Vip.Bank.Command", false);
    ...
    m_bool_configs[CONFIG_VIP_MAIL_COMMAND] = sConfigMgr->GetBoolDefault("Vip.Mail.Command", false);
    ...
    m_int_configs[CONFIG_VAS_AUTOINSTANCE] = sConfigMgr->GetIntDefault("AutoBalance.AutoInstance", false);
    m_int_configs[CONFIG_VAS_PLAYER_CHANGE_NOFITY] = sConfigMgr->GetIntDefault("AutoBalance.Player.Change.Notify", false);
    m_float_configs[CONFIG_VAS_XPlAYER] = sConfigMgr->GetFloatDefault("AutoBalance.XPlayer", 1.0f);
    m_float_configs[CONFIG_VAS_MIN_DAMAGE_MOD] = sConfigMgr->GetFloatDefault("Min.Damage.Mod", 0.10f);
    m_float_configs[CONFIG_VAS_MIN_HP_MOD] = sConfigMgr->GetFloatDefault("Min.Hp.Mod", 0.20f);
    std::string CONFIG_VAS_AUTOBALANCE_40_NAME = sConfigMgr->GetStringDefault("AutoBalance.40.Name", "");
    std::string CONFIG_VAS_AUTOBALANCE_25_NAME = sConfigMgr->GetStringDefault("AutoBalance.25.Name", "");
    std::string CONFIG_VAS_AUTOBALANCE_20_NAME = sConfigMgr->GetStringDefault("AutoBalance.20.Name", "");
    std::string CONFIG_VAS_AUTOBALANCE_10_NAME = sConfigMgr->GetStringDefault("AutoBalance.10.Name", "");
    std::string CONFIG_VAS_AUTOBALANCE_5_NAME = sConfigMgr->GetStringDefault("AutoBalance.5.Name", "");
    std::string CONFIG_VAS_AUTOBALANCE_2_NAME = sConfigMgr->GetStringDefault("AutoBalance.2.Name", "");
...
void World::SetInitialWorldSettings()
{
    ...
    // [Custom][Channel] PvP Queue Statistic
...
void World::ShutdownMsg(bool show, Player* player, const std::string& reason)
{
    ...
    if (show ||
		(m_ShutdownTimer < 0.25 * MINUTE && (m_ShutdownTimer % 1) == 0) ||
        (m_ShutdownTimer < 1* MINUTE && (m_ShutdownTimer % 5) == 0) ||
    ...
    {
		if (m_ShutdownTimer == 0.10 * MINUTE)
        {
...
void World::SendCustomPvpInformationUpdate()
{
    ...
    for (uint32 battlegroundQueue = BATTLEGROUND_QUEUE_NONE; battlegroundQueue < MAX_BATTLEGROUND_QUEUE_TYPES; ++battlegroundQueue)
    {
        ...
        BattlegroundQueue& bgQueue = sBattlegroundMgr->GetBattlegroundQueue((BattlegroundQueueTypeId)battlegroundQueue);
        ...
        for (uint32 bracket = BG_BRACKET_ID_FIRST; bracket < MAX_BATTLEGROUND_BRACKETS; ++bracket)
        {
            ...
            {
                for (BattlegroundQueue::GroupsQueueType::const_iterator itr = bgQueue.m_QueuedGroups[bracket][queueType].begin(); itr != bgQueue.m_QueuedGroups[bracket][queueType].end(); ++itr)
                {
                    if ((*itr))
                    {
                        if ((battlegroundQueue == BATTLEGROUND_QUEUE_2v2 || battlegroundQueue == BATTLEGROUND_QUEUE_3v3 || battlegroundQueue == BATTLEGROUND_QUEUE_2v2_SOLO) && !(*itr)->IsRated)
                            continue;

                        if (queueType == BG_QUEUE_PREMADE_ALLIANCE || queueType == BG_QUEUE_NORMAL_ALLIANCE || queueType == BG_QUEUE_MIXED)
                        {
                            if (battlegroundQueue == BATTLEGROUND_QUEUE_2v2 || battlegroundQueue == BATTLEGROUND_QUEUE_3v3 || battlegroundQueue == BATTLEGROUND_QUEUE_2v2_SOLO)
                                allianceCount++;
                            else
                                allianceCount += (*itr)->Players.size();
                        }

                        if (queueType == BG_QUEUE_PREMADE_HORDE || queueType == BG_QUEUE_NORMAL_HORDE || queueType == BG_QUEUE_MIXED)
                        {
                            if (battlegroundQueue == BATTLEGROUND_QUEUE_2v2 || battlegroundQueue == BATTLEGROUND_QUEUE_3v3 || battlegroundQueue == BATTLEGROUND_QUEUE_2v2_SOLO)
                                hordeCount++;
                            else
            ...
            if (allianceCount != 0 || hordeCount != 0)
            {
                if (!overallQueueFound)
                {
                    ...
                    SendMessageToAllPlayersInChannel("SucheNachGruppe", "|cffff6060========== Queue Information ==========");
                    SendMessageToAllPlayersInChannel("BuscarGrupo", "|cffff6060========== Queue Information ==========");
                    SendMessageToAllPlayersInChannel("Поиск спутников", "|cffff6060========== Queue Information ==========");
                    SendMessageToAllPlayersInChannel("ПоискCпутников", "|cffff6060========== Queue Information ==========");
                    SendMessageToAllPlayersInChannel("LookingForGroup", "|cffff6060========== Queue Information ==========");
                }
                ...
                if (!singleQueueFound)
                {
                    ...
                    if (battlegroundQueue == BATTLEGROUND_QUEUE_2v2 || battlegroundQueue == BATTLEGROUND_QUEUE_3v3 || battlegroundQueue == BATTLEGROUND_QUEUE_2v2_SOLO || battlegroundQueue == BATTLEGROUND_QUEUE_5v5)
                    {
                        switch (battlegroundQueue)
                        {
                            case BATTLEGROUND_QUEUE_2v2:
                                messageQueue << "|cffADFF2FBracket - 2vs2 : " << allianceCount + hordeCount << " Team(s)";
                                break;
                            case BATTLEGROUND_QUEUE_3v3:
                                messageQueue << "|cffADFF2FBracket - 3vs3 : " << allianceCount + hordeCount << " Team(s)";
                                break;
                            case BATTLEGROUND_QUEUE_5v5:
                                messageQueue << "|cffADFF2FBracket - 1vs1 : " << allianceCount + hordeCount << " Team(s)";
                                break;
                            case BATTLEGROUND_QUEUE_2v2_SOLO:
                                fetchQueueList();
                                messageQueue << "|cffADFF2F3vs3 Solo :" << " Melees: " << cache2v2Queue[MELEE] << " Casters: " << cache2v2Queue[RANGE] << " Healers: " << cache2v2Queue[HEALER];
                                break;
                            default:
                                break;
                        }

                        SendMessageToAllPlayersInChannel("SucheNachGruppe", messageQueue.str());
                        SendMessageToAllPlayersInChannel("BuscarGrupo", messageQueue.str());
                        SendMessageToAllPlayersInChannel("Поиск спутников", messageQueue.str());
                        SendMessageToAllPlayersInChannel("LookingForGroup", messageQueue.str());
                        messageQueue.str("");
                    }
                }
                ...
                if (battlegroundQueue != BATTLEGROUND_QUEUE_2v2 && battlegroundQueue != BATTLEGROUND_QUEUE_3v3 && battlegroundQueue != BATTLEGROUND_QUEUE_2v2_SOLO)
                {
                    if (BattlegroundTypeId typeId = sBattlegroundMgr->BGTemplateId(BattlegroundQueueTypeId(battlegroundQueue)))
                    {
                        if (Battleground* bgTemplate = sBattlegroundMgr->GetBattlegroundTemplate(typeId))
                        {
                            ...
                            {
                                uint32 MixedBG = bgTemplate->GetMinPlayersPerTeam() * 2;
                                messageQueue << GetBattlegroundAbbreviation(typeId) << " (" << bracketEntry->minLevel << "-" << bracketEntry->maxLevel << ")|cff45fe00 Для начала битвы на поле боя нужно: " << MixedBG - (allianceCount + hordeCount) << (" Player's");
                                //SendMessageToAllPlayersInChannel("Поиск спутников", messageQueue.str());
    ...
    uint32 arenaCount3vs3solo = 0;

    for (uint32 i = BATTLEGROUND_TYPE_NONE; i < MAX_BATTLEGROUND_TYPE_ID; i++)
    {
        std::map<uint32, std::pair<uint32, uint32> > storedBattlegroundCounts;

        BattlegroundContainer* Battlegrounds = sBattlegroundMgr->GetBattlegroundsByType(BattlegroundTypeId(i));
        if (Battlegrounds)
        {
            for (BattlegroundContainer::iterator itr = Battlegrounds->begin(); itr != Battlegrounds->end(); ++itr)
            {
                if ((*itr).second)
                {
                    ...
                    if ((*itr).second->isBattleground() && (*itr).second->GetStatus() >= STATUS_WAIT_JOIN && (*itr).second->GetStatus() != STATUS_WAIT_LEAVE)
                    {
        ...
        if (!storedBattlegroundCounts.empty())
        {
            if (!activeGameFound)
            {
                ...
                SendMessageToAllPlayersInChannel("BuscarGrupo", "|cffff6060========== Active BG's ==========");
                SendMessageToAllPlayersInChannel("SucheNachGruppe", "|cffff6060========== Active BG's ==========");
                SendMessageToAllPlayersInChannel("Поиск спутников", "|cffff6060========== Active BG's ==========");
                SendMessageToAllPlayersInChannel("LookingForGroup", "|cffff6060========== Active BG's ==========");
            }
            ...
            for (std::map<uint32, std::pair<uint32, uint32> >::const_iterator itr = storedBattlegroundCounts.begin(); itr != storedBattlegroundCounts.end(); ++itr)
            {
                ...
                {
                    messageActive << GetBattlegroundAbbreviation((BattlegroundTypeId)i) << " |cff00ffff(" << (*itr).first << "|cff00ffff-" << (*itr).second.first << "|cff00ffff): " << (*itr).second.second << " |cff00ffffBattleground's";
                    SendMessageToAllPlayersInChannel("Поиск спутников", messageActive.str());
                    SendMessageToAllPlayersInChannel("SucheNachGruppe", messageActive.str());
                    SendMessageToAllPlayersInChannel("BuscarGrupo", messageActive.str());
                    SendMessageToAllPlayersInChannel("LookingForGroup", messageActive.str());
                    messageActive.str("");
                }
            }
        }
    ...
    if (arenaCount2vs2 || arenaCount3vs3 || arenaCount5vs5 || arenaCount3vs3solo)
    {
        if (!activeGameFound)
        {
            activeGameFound = true;
            SendMessageToAllPlayersInChannel("SucheNachGruppe", "|cffff6060========== Active Arena's ==========");
            SendMessageToAllPlayersInChannel("BuscarGrupo", "|cffff6060========== Active Arena's ==========");
            SendMessageToAllPlayersInChannel("Поиск спутников", "|cffff6060========== Active Arena's ==========");
            SendMessageToAllPlayersInChannel("LookingForGroup", "|cffff6060========== Active Arena's ==========");
        }

        if (arenaCount2vs2)
        {
            messageActive << "|cff8B8B83Arena (Rated) - 2vs2 : " << arenaCount2vs2;
            SendMessageToAllPlayersInChannel("SucheNachGruppe", messageActive.str());
            SendMessageToAllPlayersInChannel("BuscarGrupo", messageActive.str());
            SendMessageToAllPlayersInChannel("Поиск спутников", messageActive.str());
            SendMessageToAllPlayersInChannel("LookingForGroup", messageActive.str());
        ...
        if (arenaCount3vs3)
        {
            messageActive << "|cff8B8B83Arena (Rated) - 3vs3 : " << arenaCount3vs3;
            SendMessageToAllPlayersInChannel("SucheNachGruppe", messageActive.str());
            SendMessageToAllPlayersInChannel("BuscarGrupo", messageActive.str());
            SendMessageToAllPlayersInChannel("Поиск спутников", messageActive.str());
            SendMessageToAllPlayersInChannel("LookingForGroup", messageActive.str());
        ...
        if (arenaCount5vs5)
        {
            messageActive << "|cff8B8B83Arena (Rated) - 1vs1 : " << arenaCount5vs5;
            SendMessageToAllPlayersInChannel("SucheNachGruppe", messageActive.str());
            SendMessageToAllPlayersInChannel("BuscarGrupo", messageActive.str());
            SendMessageToAllPlayersInChannel("Поиск спутников", messageActive.str());
            SendMessageToAllPlayersInChannel("LookingForGroup", messageActive.str());
        ...
        if (arenaCount3vs3solo)
        {
            messageActive << "|cff8B8B83Arena (Rated) - 3vs3 Solo Queue : " << arenaCount3vs3solo;
            SendMessageToAllPlayersInChannel("SucheNachGruppe", messageActive.str());
            SendMessageToAllPlayersInChannel("BuscarGrupo", messageActive.str());
            SendMessageToAllPlayersInChannel("Поиск спутников", messageActive.str());
            SendMessageToAllPlayersInChannel("LookingForGroup", messageActive.str());
...
void World::fetchQueueList()
{
    ...
    for (int i = BG_BRACKET_ID_FIRST; i <= BG_BRACKET_ID_LAST; i++)
        for (int y = 0; y < 2; ++y)
        {
            for (BattlegroundQueue::GroupsQueueType::iterator itr = queue->m_QueuedGroups[i][y].begin(); itr != queue->m_QueuedGroups[i][y].end(); itr++)
            {
