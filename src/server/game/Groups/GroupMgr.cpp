...
Group* GroupMgr::GetGroupByInstanceId(uint32 instanceId) const
{
    // this is pretty new, unexistant in the core
    PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_SEL_GROUP_INSTANCE);
