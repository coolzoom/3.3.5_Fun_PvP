...
if(WITHOUT_GIT)
  set(rev_date "X-WoW Core 2020.01.27")
  set(rev_hash "Linux Core")
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"Linux Core X-WoW Core 2020.01.27 (Archived)\"")
    set(rev_date "X-WoW Core 2018-15.02 00:00:00 +0015")
    set(rev_hash "Linux Core")
    set(rev_branch "Archived")
  else()
